		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Testing with WebDriverIO",
									"targetURL": "#webdriveriotesting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"webdriveriotesting-display": {
								"semanticObject": "webdriveriotesting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=webdriveriotesting",
									"url": sap.ui.require.toUrl("webdriveriotesting")
								}
							}
						}
					}
